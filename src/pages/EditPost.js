...
class EditPost extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      title: props.location && props.location.state ? props.location.state.post.title : '' ,
      body:  props.location && props.location.state ? props.location.state.post.body : '',
      errMessage: '',
      file: '',
    };
  }
  ...
  componentDidMount(){
      ...
      this.context.userInfo.uid !== this.props.location.state.post.userId && this.props.history.push('/posts')
  }
  editPost = (e)=>{
      e.preventDefault();
      ...
      formData.append("pid", this.props.location.state.post.pid);
  ...
  render() {
    ...
    return (
        ...
        <Error message={errMessage}/>
          ...
          <div>
          <button type="submit" onClick={this.editPost}>Submit</button>
          </div>
        </form>
